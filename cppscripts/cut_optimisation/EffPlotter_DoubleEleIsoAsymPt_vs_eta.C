...
void EffPlotter_DoubleEleIsoAsymPt_vs_eta() {
  ...
  TLegend *leg_example2 = new TLegend(0.3,0.2,0.75,0.55);
  ...
  my_canvas1->Update();
  my_canvas1->SaveAs("DoubleEleIso_fullEff_vs_geneta_leg_1_2_zprime.png");
}
