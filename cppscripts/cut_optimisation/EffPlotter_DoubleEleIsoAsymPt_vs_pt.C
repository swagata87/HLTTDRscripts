...
void EffPlotter_DoubleEleIsoAsymPt_vs_pt() {

  TFile *file_sig = new TFile("hist_Zprime_DoubleEleIsolatedAsymPt_L1seeded.root");
  ...
  leg_example2->AddEntry((TObject*)0, "HLT_DoubleEle23_12_Iso", "");
  ...
  leg_example22->AddEntry((TObject*)0, "HLT_DoubleEle23_12_Iso", "");
  ...
  my_canvas1->SaveAs("DoubleEleIso_fullEff_vs_genpt_EB_leg_1_2_zprime.png");
  my_canvas2->SaveAs("DoubleEleIso_fullEff_vs_genpt_EE_leg_1_2_zprime.png");
