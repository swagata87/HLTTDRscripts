...
#ifdef CutOpt_cxx
CutOpt::CutOpt(TTree *tree) : fChain(0) 
{
...
Int_t CutOpt::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t CutOpt::LoadTree(Long64_t entry)
{
...
void CutOpt::Show(Long64_t entry)
{
...
Int_t CutOpt::Cut(Long64_t entry)
{
